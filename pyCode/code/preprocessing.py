...
parser.add_argument('--data', type=str, default='/opt/ml/final project/data/worked/')
...
if args.model == 'multivae':
    ...
    # Load Data
    DATA_DIR = args.data
    raw_data = pd.read_csv('/opt/ml/final project/data/worked/vae_train.csv', header=0)
    ...
    ##아이템 ID
    song_df = pd.read_json('/opt/ml/final project/data/original/song_meta.json')
